...
uint256 hashGenesisBlock("0x1c8c90ac75d69d5efefb03dd8cbf64ce548ea59f83e4ff6d653995f22449c210");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 420000); // Lucycoin: 420k blocks in ~2 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 2 * 24 * 60 * 60; // Lucycoin: 2 days
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x27267a934a64fc455fc7bc5ea2feb6b198ee3793c81886cc8b23deec5a18d0d4");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "28.05.2021 - It's a very sunny day today. A good day to create a coin!";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 24 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04db0f51887962b768c9cab4ffba0700a1201d2ed08eb49ed0ec91d4dd7709516f039b427b6846c3602ad871b68ffcc4dcb79b85c5c122bbaa39a64584d9e1c595") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1622217314;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2085795224;

        if (fTestNet)
        {
            block.nTime    = 1622217302;
            block.nNonce   = 386096324;
        }
	if (true && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0xc74ab70fb1d1d23a1f9f916fbc62168c519c3a077890829a0b635ec3248a46ac"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfl, 0xc1, 0xb3, 0xdf }; // Lucycoin: increase each by adding 2 to bitcoin's value.
